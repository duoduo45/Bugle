...
- (void)setRequestMethod:(NSString *)newRequestMethod
{
	...
	if (requestMethod != newRequestMethod) {
		...
		if ([requestMethod isEqualToString:@"DELETE"] || [requestMethod isEqualToString:@"POST"] || [requestMethod isEqualToString:@"PUT"] || [postBody length] || postBodyFilePath) {
...
- (void)buildRequestHeaders
{
	...
	// Accept data form, by Lei
	[self addRequestHeader:@"Accept" value:@"*/*"];
